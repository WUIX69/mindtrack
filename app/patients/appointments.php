...
<head>
    ...
    <title>Appointments - MindTrack</title>
    ...
    <div class="flex min-h-screen">
        ...
        <div class="flex-1 p-8">
            <div class="bg-white rounded-2xl shadow-xl p-8">
                ...
                <p class="text-gray-600 mb-6">Manage patient appointments and schedules</p>

                <div class="ui info message">
                    <div class="header">Coming Soon</div>
                    <p>This page is under development. Appointments feature will be available soon.</p>
                </div>
            </div>
        </div>
    </div>
